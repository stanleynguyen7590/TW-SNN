...
if __name__ == '__main__':
    ...
    parser.add_argument('--en_find_threshold', action='store_true',help="find threshold")
    ...
    en_find_threshold   = args.en_find_threshold
    ...
    if pretrained_ann:
        ...
        f.write('\n Info: Enable find threshold: {}'.format(en_find_threshold))
        if en_find_threshold:
